...
const bookSchemaUpdate = require("../schemas/booksSchemaUpdate")
const ExpressError = require("../../../36.1/express-messagely/expressError");
...
router.post("/", async function (req, res, next) {
  ...
  if(!result.valid) {
    let errList = result.errors.map(e => e.stack);
